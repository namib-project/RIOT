            ...
            case DHCPV6_OPT_IA_NA:
                for (unsigned i = 0; i < CONFIG_DHCPV6_CLIENT_LEASE_MAX; i++) {
                    ...
                    if ((iaaddr != NULL)) {
                        ...
                        /* TODO: Add IP Address to interface */
                    }
                }
                break;
            default:
...
static void _request_renew_rebind(uint8_t type)
{
    ...
    switch (type) {
        ...
        case DHCPV6_REBIND: {
            ...
            for (unsigned i = 0; i < CONFIG_DHCPV6_CLIENT_LEASE_MAX; i++) {
                // const addr_lease_t *lease = &addr_leases[i]; /* currently unused */
                uint32_t valid_until = 5U;
                /* TODO: Add function to determine "valid_until" for addr_leases */
